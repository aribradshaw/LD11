<?php
// Fixed version of the main API with better error handling
...
switch ($request) {
    ...
    default:
        ...
        echo json_encode(['error' => 'Endpoint not found', 'requested' => $request]);
        break;
}
...
function getAdSpendData() {
    ...
    try {
        ...
        echo json_encode(['error' => 'Failed to process ad spend data: ' . $e->getMessage()]);
    }
}
...
function getVoterData() {
    ...
    try {
        ...
        http_response_code(500);
        echo json_encode(['error' => 'Failed to process voter data: ' . $e->getMessage()]);
    }
}
...
function getResultsData() {
    ...
    try {
        ...
        http_response_code(500);
        echo json_encode(['error' => 'Failed to process results data: ' . $e->getMessage()]);
    }
}
